...
if __name__ == '__main__':
    ...
    substeps = 4
    dt = (1 / 60) / substeps
    frame_num = 60 * substeps
    # Simulation parameters.
    thread_ct = 6
    opt = { 'max_pd_iter': 1000, 'max_ls_iter': 10, 'abs_tol': 1e-9, 'rel_tol': 1e-9, 'verbose': 0, 'thread_ct': thread_ct,
    ...
    env.simulate(dt, frame_num, method, opt, q0, v0, a0, f0, require_grad=False, vis_folder='init', render_frame_skip=substeps)
