...
#ifndef SPECTRA_SPARSE_GEN_REAL_SHIFT_SOLVE_PARDISO_H
#define SPECTRA_SPARSE_GEN_REAL_SHIFT_SOLVE_PARDISO_H
...
public:
    ...
    SparseGenRealShiftSolvePardiso(const Eigen::SparseMatrixBase<Derived>& mat) :
        m_mat(mat), m_n(mat.rows())
    {
        // static_assert(
        //     static_cast<int>(Derived::PlainObject::IsRowMajor) == static_cast<int>(SparseMatrix::IsRowMajor),
        //     "SparseGenRealShiftSolvePardiso: the \"Flags\" template parameter does not match the input matrix (Eigen::ColMajor/Eigen::RowMajor)");
    ...
    void set_shift(const Scalar& sigma)
    {
        ...
        solver.Compute(m_mat - sigma * I, options);
...
#endif  // SPECTRA_SPARSE_GEN_REAL_SHIFT_SOLVE_PARDISO_H
